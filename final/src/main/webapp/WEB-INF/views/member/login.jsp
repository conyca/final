			...
			<form action="login.do" method="post" onsubmit="return onSubmit();">
				...
				<fieldset>
					...
					<div class="rowGroup">
						<div class="loginRow">
							<span class="inputBox">
								<input type="text" id="id" name="id" onblur="checkId();" tabindex="7" accesskey="L" placeholder="아이디" class="int" maxlength="41" >
							</span> 
						...
						<div class="loginRow">
							<span> 
								<input type="password" id="pw" name="pass" tabindex="8" onblur="passCheck();" placeholder="비밀번호" class="int" maxlength="16" onkeypress="capslockevt(event);getKeysv2();" onkeyup="checkShiftUp(event);" onkeydown="checkShiftDown(event);">
							</span>
